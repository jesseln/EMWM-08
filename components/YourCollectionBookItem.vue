<template>
    ...
    <div class="item-wrapper" v-on="itemHandlers" :style="{ maxHeight: scales.maxItemHeight + 'px', height: itemHeightYC(getIDP_YC(item,'height')) + 'px', width:scales.minItemWidth + 'px'}">    
        ...
        <div class="book-item" :style="{ maxHeight: scales.maxItemHeight-4 + 'px', height: itemHeightYC(getIDP_YC(item,'height'))-4 + 'px' , background: itemColourYC(getIDP_YC(item, 'colour')),
