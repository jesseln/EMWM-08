<template>
    ...
    >
        <div class="item-wrapper" v-on="itemHandlers" :style="{ maxHeight: scales.maxItemHeight + 'px', height: itemHeightYC(getIDP_YC(item,'height')) + 'px', width:scales.minItemWidth + 'px'}">    
            <div class="mark-item-top" :style="{ background: itemColourYC(getIDP_YC(item, 'colour')), width:scales.minItemWidth - 2 + 'px'}"></div>
            <div class="mark-item-top-background" :style="{ width:scales.minItemWidth + 2 + 'px'}"></div>
            <div class="mark-item-background" :style="{ maxHeight: scales.maxItemHeight-20  + 'px', height: itemHeightYC(getIDP_YC(item,'height'))-20 + 'px',width:scales.minItemWidth + 2 + 'px'}"></div>

            <div class="mark-item" :style="{ maxHeight: scales.maxItemHeight-23 + 'px', height: itemHeightYC(getIDP_YC(item,'height'))-23 + 'px' , background: itemColourYC(getIDP_YC(item, 'colour')),
...
<div class="item-value" :style="{ color: contrastHandler(itemColourYC(getIDP_YC(item, 'colour')))}">
        ...
        <template #popper >
            ...
            <div class="item-menu-totals-and-button">
